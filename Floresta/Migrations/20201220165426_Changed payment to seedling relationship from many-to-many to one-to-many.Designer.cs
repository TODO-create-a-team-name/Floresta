...
namespace Floresta.Migrations
{
    ...
    [Migration("20201220165426_Changed payment to seedling relationship from many-to-many to one-to-many")]
    partial class Changedpaymenttoseedlingrelationshipfrommanytomanytoonetomany
    {
